 ...
 serve(async (req) => {
   ...
   try {
     ...
     // Use Geocoding API as a search mechanism (this is enabled as it's used for GPS reverse geocoding)
     // Search for the input text with India region bias
     ...
     return new Response(
       JSON.stringify({ error: error.message || 'Failed to search places', predictions: [] }),
